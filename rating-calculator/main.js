...
let mobCol1 = document.getElementById("mob1");
let mobCol2 = document.getElementById("mob2");
let mobCol3 = document.getElementById("mob3");
...
// handle NaN in rating avg
let handleNan = (field) =>
	field.innerText === "NaN" ? (field.innerText = 0) : null;
